...
void fitfun_init()
{
	...
	double *theta = malloc(N_samples*2*sizeof(double));
	...
	double *sigma = malloc(N_sensors*N_sensors*sizeof(double));
	...
	double **z;
	z  = calloc(1, N_u*sizeof(double *));
	for (int n = 0; n < N_u; n++)
		z[n]  = calloc(1, N_samples*N_sensors*sizeof(double));
